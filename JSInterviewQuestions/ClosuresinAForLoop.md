...
/*3.  Predict the output*/                                                             
 ...
 /*ans-b                                                                                   
 EXPLANATION :  ECMAScript 6 (ES6) introduces new let and const keywords */              
             /* that are scoped differently than var-based variables.                   
                For example, in a loop with a let-based index, each iteration                   
...
/*4.Predict the output */
 ...
 /*EXPLANATION:In loops, you get a fresh binding for each iteration  if you let-declare a variable.               
...
/*
EXPLANATION : a var declaration leads to a single binding for the whole loop (a const declaration works the same):
*/
```
